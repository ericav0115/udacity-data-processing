...
#EV: Updated default_args 6/12/26
default_args = {
    'owner': 'udacity',
...
def final_project():
    ...
    end_operator = DummyOperator(task_id='Stop_execution') #EV: added end operator
    ...
    stage_events_to_redshift = StageToRedshiftOperator(
        ...
        s3_bucket='erica-vaughn',
        s3_key='log-data',
        json_path='s3://erica-vaughn/log_json_path.json'
    ...
    load_songplays_table = LoadFactOperator( #should only append data
